...
@section('content')
    ...
    <body class=" relative min-h-screen rounded-lg bg-gradient-to-r from-blue-400/10 via-purple-500/10 to-pink-500/10">
        <form id="frmIzin" action="/presensi/cis/{{ $dataIzin->kode_izin }}/update" enctype="multipart/form-data"
            ...
            <div class="space-y-6">
                <div class="relative w-full max-w-sm input-wrapper mx-auto sm:mx-0">
                    ...
                    <input name="tgl_izin_dari" value="{{ $dataIzin->tgl_izin_dari }}" id="tgl_izin_dari" type="text"
                ...
                <div class="relative w-full max-w-sm input-wrapper mx-auto sm:mx-0">
                    ...
                    <input name="tgl_izin_sampai" id="tgl_izin_sampai" value="{{ $dataIzin->tgl_izin_sampai }}"
                        type="text" placeholder="Sampai" autocomplete="off" />
                </div>
                ...
                <div class="relative w-full max-w-sm mx-auto sm:mx-0">
                    <label for="foto_izin" class="block mb-2 font-semibold text-indigo-700 select-none">Upload Foto (jpg,
                        jpeg, png)</label>
                    <div tabindex="0" role="button" aria-label="Upload Foto Izin"
                        class="file-upload-wrapper focus:outline-none focus:ring-4 focus:ring-indigo-400 focus:ring-opacity-50"
                        id="fileUploadWrapper">
                        <i class="fas fa-cloud-upload-alt file-upload-icon"></i>
                        <div class="file-upload-text">Klik atau seret file ke sini</div>
                        <div class="file-upload-subtext">Format: jpg, jpeg, png. Maks 5MB.</div>
                        <input type="file" name="ftcis" id="foto_izin" accept=".jpg,.jpeg,.png"
                            class="file-upload-input" aria-describedby="fileHelp" />
                    </div>
                    <img id="filePreview" alt="Preview foto izin sakit" class="file-preview hidden mx-auto mt-4" />
                </div>
...
@push('myscript')
    <script>
        ...
        const fotoInput = document.getElementById('foto_izin');
        ...
        fotoInput.addEventListener('change', () => {
            ...
            if (!allowedTypes.includes(file.type)) {
                Swal.fire({
                    ...
                    text: 'File foto harus berformat jpg, jpeg, atau png.',
                });
                fotoInput.value = '';
                filePreview.src = '';
                filePreview.classList.add('hidden');
        ...
        function validateAndConfirm() {
            ...
            if (!fotoFile) {
                Swal.fire({
                    icon: 'error',
                    title: 'Foto harus diupload',
                    text: 'Silakan upload file foto dengan format jpg, jpeg, atau png.',
                });
                return;
            }
